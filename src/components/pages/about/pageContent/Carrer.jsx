...
const Carrer = () => {
  ...
  return (
    <section className="flex min-h-screen flex-col gap-2 px-2 py-4 sm:gap-8 sm:px-6 lg:p-8 xl:p-10">
      <div className="w-[95%] max-w-[1344px] self-center sm:w-[90%] xl:w-full">
        <h2 className="text-xl lg:text-2xl">My Carrer</h2>
        <div className="flex items-center xl:flex-row" ref={ref}>
          {/* left side */}
          ...
          {/* right side */}
          <div className="hidden h-full w-full flex-col pl-8 lg:flex xl:w-1/2">
            ...
            <div className="clip-cat h-[688px] bg-gradient-to-b from-light-theme-3 to-transparent dark:from-dark-theme-1" />
          </div>
        </div>
      </div>
    </section>
