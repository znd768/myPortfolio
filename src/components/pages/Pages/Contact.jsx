...
const Contact = () => {
  return (
    <section className="flex min-h-[calc(100vh-5rem)] flex-col gap-8 px-4 py-4 sm:px-6 lg:p-8 xl:p-10">
      <h1 className="text-2xl lg:text-3xl xl:text-4xl">Contact</h1>
      <div className="w-[95%] max-w-[1344px] self-center sm:w-[90%] lg:w-[800px] xl:w-full xl:px-12">
        <div className="flex overflow-hidden rounded-3xl bg-trans-black shadow-2xl backdrop-blur-2xl xl:flex-row">
          ...
          <div className="flex h-full w-full flex-col p-12 xl:w-1/2">
            <form className="flex h-full flex-col justify-center gap-4">
              ...
              <button className="mt-4 bg-trans-white py-2 text-xl">
                Send Message
              </button>
            </form>
          </div>
